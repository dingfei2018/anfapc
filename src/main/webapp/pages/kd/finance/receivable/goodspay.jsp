...
<div class="banner">
	...
	<div class="banner-right">
		<ul>
			...
			<li><a href="/kd/finance/receivable/goodsPayIndex" class="activet at">贷款扣</a></li>
		</ul>
		<form id="searchForm" onsubmit="return false;">
			<div class="banner-right-list">
				...
				<div class="div">
					<span class="span" style="text-align: center;vertical-align: middle;width:60px; margin-left: 20px;">贷款扣结算状态：</span>
					<select name="feeStatus" style="vertical-align: middle;">
	...
	<div class="banner-right-list2">
		<ul class="ul2">
			<li style="border: 1px solid #3974f8;"><a class="banner-right-a3" style="color: #3974f8; background: #fff; border: none;"  onclick="window.location.href='/kd/finance/receivable/goGoodsPayJS'">结算</a></li>
		...
		<p class="banner-right-p">贷款扣列表</p>
...
<script src="${ctx}/static/kd/js/receivable/re_goodspay.js"></script>
<script>
