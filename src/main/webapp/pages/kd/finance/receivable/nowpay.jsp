...
<body>
	...
	<div class="banner">
		...
		<div class="banner-right">
			<ul>
				...
				<li><a href="/kd/finance/receivable/nowpayIndex" class="activet at">现付</a>
		...
		<ul class="ul2">
			<li style="border: 1px solid #3974f8;"><a class="banner-right-a3" style="color: #3974f8; background: #fff; border: none;"  onclick="window.location.href='/kd/finance/receivable/goNowpayJS'">结算</a></li>
				...
				<li style="float: right;margin-top: -7px;"><div id="page" style="text-align: center;"></div></li>
			</ul>
			<p class="banner-right-p">现付列表</p>
	...
	<script src="${ctx}/static/kd/js/receivable/re_nowpay.js"></script>
	<script>
