...
<div class="banner">
	...
	<div class="banner-right">
		...
		<form id="searchForm" onsubmit="return false;">
			<div class="banner-right-list">
				...
				<div class="div">
					<span class="span" style="text-align: center;vertical-align: middle;width:60px; margin-left: 20px;">短欠付结算状态：</span>
	...
	<div class="banner-right-list2">
		<ul class="ul2">
			<li style="border: 1px solid #3974f8;"><a class="banner-right-a3" style="color: #3974f8; background: #fff; border: none;"  onclick="window.location.href='/kd/finance/receivable/goArrearsPayJS'">结算</a></li>
		...
		<p class="banner-right-p">短欠付列表</p>
...
<script src="${ctx}/static/kd/js/receivable/re_arrearspay.js"></script>
<script>
