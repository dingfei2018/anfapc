...
<div class="banner">
	...
	<div class="banner-right">
		<ul>
			...
			<li><a href="/kd/finance/receivable/receiptPayIndex" class="activet at">回单付</a>
		...
		<form id="searchForm" onsubmit="return false;">
			<div class="banner-right-list">
				...
				<div class="div">
					<span class="span" style="text-align: center;vertical-align: middle;width:60px; margin-left: 20px;">回单付结算状态：</span>
	...
	<div class="banner-right-list2">
		<ul class="ul2">
			<li style="border: 1px solid #3974f8;"><a class="banner-right-a3" style="color: #3974f8; background: #fff; border: none;"  onclick="window.location.href='/kd/finance/receivable/goReceiptPayJS'">结算</a></li>
			<li style="border: 1px solid #3974f8;"><a id="excelExport" class="banner-right-a3" style="color: #3974f8; background: #fff; border: none;">导出EXCEL</a>
			</li>
			<li><div id="page" style="text-align: center;"></div></li>
		</ul>
		<p class="banner-right-p">回单付列表</p>
...
<script src="${ctx}/static/kd/js/receivable/re_receiptpay.js"></script>
<script>
