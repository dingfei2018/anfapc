...
<body>
	...
	<div class="banner">
		...
		<div class="banner-right">
			...
			<div class="banner-right2">货款扣结算</div>
			...
			<div class="banner-right-list2">
				...
				<p class="p">合计<span id="leftDan"></span>单，货款扣<span id="leftFee"></span>元</p>
			</div>
			<div class="banner-right-list3">
				...
				<p class="p">合计<span id="rightDan"></span>单，货款扣<span id="rightFee"></span>元</p>
			</div>

		</div>
	</div>
	<%@ include file="../../common/loginfoot.jsp"%>
	<script src="${ctx}/static/kd/js/receivable/re_goodspay_js.js"></script>
</body>
