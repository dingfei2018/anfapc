...
<meta charset="UTF-8">
<title>应收管理</title>
<link rel="stylesheet" href="${ctx}/static/kd/css/receivabler.css" />
...
<body>
	...
	<div class="banner">
		...
		<div class="banner-right">
		   <ul>
				<li><a href="/kd/finance/receivable" class="activet at">全部</a></li>
	...
	<script src="${ctx}/static/kd/js/receivable/re_all.js"></script>
	<script>
