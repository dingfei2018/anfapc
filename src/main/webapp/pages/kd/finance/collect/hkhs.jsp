...
<meta charset="UTF-8">
<title>货款回收</title>
<link rel="stylesheet" href="${ctx}/static/kd/css/hkhs.css" />
	...
	<div class="banner-right">
		...
		<div class="banner-right-list3">
			<div class="banner-right-list3-left">
				...
				<input type="button" class="button" id="huishou"  value="确认货款回收">
			</div>
...
<script src="${ctx}/static/kd/js/collect/hkhs.js"></script>
</html>