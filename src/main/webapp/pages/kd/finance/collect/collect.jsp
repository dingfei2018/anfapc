...
<head>
    <meta charset="UTF-8">
    <title>代收货款</title>
    <link rel="stylesheet" href="${ctx}/static/kd/css/dshk.css" />
...
<div class="banner">
    ...
    <div class="banner-right">
    			<ul>
					<li>
						<a href="${ctx}/kd/finance/collect" class="am">我的货款</a>
					</li>
					<li>
						<a href="${ctx}/kd/finance/collect/collectLoan" class="activet am">代收货款</a>
					</li>
				</ul>
        ...
        <div class="banner-right-list2">
          <ul class="ul2">
                <li>
                    <a href="${ctx}/kd/finance/collect/moneyCallBack" class="banner-right-a3 at" >货款回收</a>

                </li>  
                <li> 
                    <a href="${ctx}/kd/finance/collect/moneyRemittance" class="banner-right-a3 at" >货款汇款</a>
                </li> 
                <li>
            ...
            <p class="banner-right-p">代收货款列表</p>
...
<script src="${ctx}/static/kd/js/collect/collection.js?v=${version}"></script>
</body>
