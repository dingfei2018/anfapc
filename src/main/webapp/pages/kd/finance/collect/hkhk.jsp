...
<meta charset="UTF-8">
<title>货款汇款</title>
<link rel="stylesheet" href="${ctx}/static/kd/css/hkhk.css" />
	...
	<div class="banner-right">
		...
		<div class="banner-right-list3">
			<div class="banner-right-list3-left">
				...
				<input type="button" class="button" id="huikuan"  value="确认货款汇款">
			</div>
...
<script src="${ctx}/static/kd/js/collect/hkhk.js"></script>
</html>