...
<meta charset="UTF-8">
<title>货款发放</title>
<link rel="stylesheet" href="${ctx}/static/kd/css/hkff.css" />
	...
	<div class="banner-right">
		...
		<div class="banner-right-list3">
			<div class="banner-right-list3-left">
				...
				<input type="button" class="button" id="fafang"  value="确认货款发放">
			</div>
...
<script src="${ctx}/static/kd/js/collect/hkff.js"></script>
</html>