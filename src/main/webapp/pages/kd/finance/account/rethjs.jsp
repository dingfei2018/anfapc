...
<meta charset="UTF-8">
<title>提付对账</title>
<link rel="stylesheet" href="${ctx}/static/kd/css/paybalance.css" />
		...
		<div class="banner-right">
			...
			<div class="banner-right-list2">
			  ...
			  <div class="div">
			   ...
			   <div style="width: 100%;overflow-y:auto; overflow-x:auto; height:551px;" id="loadingId">
				...
				<p class="p">合计<span id="leftDan"></span>单，提付<span id="leftFee"></span>元</p>
			</div>
            <div class="banner-right-list3">
             <div class="banner-right-list3-left">
				...
				<p class="p">合计<span id="rightDan"></span>单，提付<span id="rightFee"></span>元</p>
			</div>
...
<script src="${ctx}/static/kd/js/account/rethjs.js"></script>
</html>