...
<div class="banner">
	...
	<div class="banner-right">
		...
		<div class="banner-right-list2">
			...
			<p class="p">合计<span id="leftDan"></span>单，操作费用<span id="leftFee"></span>元</p>
		</div>
		<div class="banner-right-list3">
			...
			<p class="p">合计<span id="rightDan"></span>单，操作费用<span id="rightFee"></span>元</p>
		</div>
...
<script src="${ctx}/static/kd/js/account/reczdzjs.js"></script>
</html>