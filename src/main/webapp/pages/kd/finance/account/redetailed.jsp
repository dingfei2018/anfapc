...
<html>
		...
		<div class="banner">
			...
			<div class="banner-right">
				<ul>
					...
					<li>
						<a href="${ctx }/kd/finance/account/reDetailedIndex" class="activet at">操作应收</a>
					</li>
					<li>
				...
				<div class="banner-right-list2">
					<ul class="ul2">
						<li><a class="a4" onclick="window.location.href='/kd/finance/account/goReDetailedJS'">结算</a></li>
					...
					<script >$("#loadingId").mLoading("show");</script>
						<table border="0" class="tab_css_1" style="border-collapse:collapse;" id="table">
							<tr>
							<th>序号</th><th>运单号</th><th>开单网点</th><th>到货网点</th><th>费用合计</th><th>对账结算状态</th><th>运单状态</th>
							<th>提货费</th><th>送货费</th><th>短驳费</th><th>中转费</th><th>现付运输费</th><th>现付油卡费</th><th>回付运输费</th>
							<th>整车保险费</th><th>发站装车费</th><th>发站其他费</th><th>到付运输费</th><th>到站卸车费</th><th>到站其他费</th>
	...
	<script src="${ctx}/static/kd/js/account/reczdz.js"></script>
	<script type="text/javascript">
