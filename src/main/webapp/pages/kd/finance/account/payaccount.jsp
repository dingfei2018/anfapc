...
<div class="banner">
	...
	<div class="banner-right">
		...
		<div class="banner-right-list2">
			<ul class="ul2">
				<li><a class="a4" onclick="window.location.href='/kd/finance/account/goPayPickupJS'">结算</a></li>
			...
			<div style="overflow: auto; width: 100%;" id="loadingId">
				...
				<table border="0" class="tab_css_1" style="border-collapse:collapse;" id="table">
					<tr>
						<th>序号</th><th>运单号</th><th>到货网点</th><th>开单网点</th><th>提付</th><th>对账结算状态</th><th>运单状态</th>
...
<script src="${ctx}/static/kd/js/account/paythdz.js"></script>
<script type="text/javascript">
