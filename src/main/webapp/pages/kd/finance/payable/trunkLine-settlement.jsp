	...
	<div class="banner">
		...
		<div class="banner-right">
				...
				<ul>
					...
					<li>
						<a href="${ctx}/kd/finance/payable/loadTransportPage?transportType=3&trunkLineType=1" class="at" id="trunkLineType1">现付运输费</a>
					</li>
					<li>
						<a href="${ctx}/kd/finance/payable/loadTransportPage?transportType=3&trunkLineType=2" class="at" id="trunkLineType2">现付油卡费</a>
					</li>
					<li>
						<a href="${ctx}/kd/finance/payable/loadTransportPage?transportType=3&trunkLineType=3" class="at" id="trunkLineType3">回付运输费</a>
					</li>
					<li>
						<a href="${ctx}/kd/finance/payable/loadTransportPage?transportType=3&trunkLineType=4" class="at" id="trunkLineType4">整车保险费</a>
					</li>
					<li>
						<a href="${ctx}/kd/finance/payable/loadTransportPage?transportType=3&trunkLineType=5" class="at" id="trunkLineType5">发站装车费</a>
					</li>
					<li>
						<a href="${ctx}/kd/finance/payable/loadTransportPage?transportType=3&trunkLineType=6" class="at" id="trunkLineType6">发站其他费</a>
					</li>
					<li>
						<a href="${ctx}/kd/finance/payable/loadTransportPage?transportType=3&trunkLineType=7" class="at" id="trunkLineType7">到付运输费</a>
					</li>
					<li>
						<a href="${ctx}/kd/finance/payable/loadTransportPage?loadAtFeeFlag=0" class="at" id="trunkLineType8">到站卸车费</a>
					</li>
					<li>
						<a href="${ctx}/kd/finance/payable/loadTransportPage?loadAtFeeFlag=1" class="at" id="trunkLineType9">到站其他费</a>
					</li>
				</ul>
				<form onsubmit="return false;" id="confirmform">
					<div class="banner-right-list">
						<p class="banner-right-p">${Map.feeType}结算</p>
						<div class="div">
						...
						<div class="div">
							...
							<input type="text" name="remark"  /><input id="trunkLineType" type="hidden"  name="trunkLineType" value="${Map.trunkLineType}" />
						</div>
...
<script src="${ctx}/static/kd/js/payable/trunk-settlement.js"></script>