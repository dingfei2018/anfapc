...
<head>
    ...
    <%@ include file="../../common/commonhead.jsp" %>
     <script src="${ctx}/static/kd/js/payable/trunkLineTypeList.js?v=${version}"></script>
</head>
<body>
...
<div class="banner">
    ...
    <div class="banner-right">
        <ul>
            ...
            <li>
                <a href="#" class="actives at">现付运输费</a>
            </li>
            <li>
        ...
        <div class="banner-right-list">
            <form id="searchFrom" onsubmit="return false;">
                ...
                <div class="div">
                    <span class="span">发车日期：</span><input type="text" name="startTime"
        ...
        <div class="banner-right-list2">
            <ul class="ul2">
	            <li>
	                    <a href="/kd/finance/payable/trunkLineSettlement?trunkLineType=1" class="banner-right-a3" id="accountId" style="color:#3974f8; background: #fff;border: none;">结算</a>
	                </li>
                <li>
                    <a href="#" class="banner-right-a3" id="excelExport" trunkLineType="1" style="color:#3974f8; background: #fff;border: none;">导出EXCEL</a>
                </li>
            ...
            <p class="banner-right-p" >现付运输费列表</p>
            <div style="overflow: auto; width: 100%;  " id="loadingId" trunkLineType="1">
                <table border="0" class="tab_css_1" style="border-collapse:collapse;" id="loadId">
                   ...
                   <%-- <tr>
                      <td>1</td>
                      <td><a style="color:#3974f8;">PZ201711200001</a></td>
                      <td>广州安发</td>
                      <td>长沙望城</td>
                      <td style="color:orange">2000</td>
                      <td style="color:orange">0</td>
                      <td style="color:orange">已结清</td>
                      <td>2017-11-06</td>
                      <td>粤B12345</td>
                      <td>张三</td>
                      <td>13512345678</td>
                      <td style="color:orange">配载中</td>
                      <td>广州市白云区</td>
                      <td>长沙市</td>
                      <td>120</td>
                      <td>45.5</td>
