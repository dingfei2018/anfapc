...
<div class="banner">
    ...
    <div class="banner-right">
        <ul>
            ...
            <li>
                <a href="#" class="actives at">整车保险费</a>
            </li>
            <li>
                        ...
                        <div class="form-group">
                            ...
                            <script>
                                $(function () {
                                    ...
                                    console.log($(".city-picker-span").css("width", "auto"));
                                });
                            </script>
                        </div>
                    </div>
        ...
        <div class="banner-right-list2">
            <ul class="ul2">
	            <li>
	                    <a href="/kd/finance/payable/trunkLineSettlement?trunkLineType=4" class="banner-right-a3" id="accountId" style="color:#3974f8; background: #fff;border: none;">结算</a>
	                </li>
                <li>
                    <a href="#" class="banner-right-a3" id="excelExport" trunkLineType="4" style="color:#3974f8; background: #fff;border: none;">导出EXCEL</a>
                </li>
            ...
            <p class="banner-right-p" >整车保险费列表</p>
            <div style="overflow: auto; width: 100%;  " id="loadingId" trunkLineType="4">
