...
<div class="banner">
	...
	<div class="banner-right">
		...
		<div class="banner-right-list2">
			<ul class="ul2">
				<li>
					<a class="banner-right-a3" onclick="window.location.href='/kd/finance/payable/settlement?transportType=2'">结算</a>
				</li>
				<li>
					<a href="#" class="banner-right-a3" id="excelExport" transportType="2" style="color:#3974f8; background: #fff;text-decoration:underline;border: none;">导出EXCEL</a>
				</li>
				<li>
					<div id="page" style="text-align: center;"></div>
				</li>
			</ul>
			<p class="banner-right-p">短驳费列表</p>
