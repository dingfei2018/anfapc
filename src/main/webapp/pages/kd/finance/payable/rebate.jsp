...
<head>
    <meta charset="UTF-8">
    <title>回扣</title>
    <link rel="stylesheet" href="${ctx}/static/kd/css/rebate.css?v=${version}">
    <link rel="stylesheet" href="${ctx}/static/pc/css/head2.css"/>
    <link rel="stylesheet" href="${ctx}/static/pc/css/footer.css"/>
    <link rel="stylesheet" href="${ctx}/static/pc/css/dropdown.css"/>
    <%@ include file="../../common/commonhead.jsp" %>
     <script src="${ctx}/static/kd/js/payable/rebatepay.js?v=${version}"></script>
</head>
<body>
...
<div class="banner">
    ...
    <div class="banner-right">
        <ul>
            ...
            <li>
                <a href="${ctx}/kd/finance/payable/rebate" class="actives at">回扣</a>
            </li>
            <li>
        ...
        <div class="banner-right-list">
            <form id="searchFrom" onsubmit="return false;">
                ...
                <div class="div">
                    <span class="span">开单日期：</span><input type="text" name="startTime"
        ...
        <div class="banner-right-list2">
            <ul class="ul2">
	            <li>
	                    <a href="/kd/finance/payable/goRebateJs" class="banner-right-a3" id="accountId" style="color:#3974f8; background: #fff;border: none;">结算</a>
	                </li>
                <li>
