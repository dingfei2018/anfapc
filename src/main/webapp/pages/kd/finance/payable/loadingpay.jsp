...
<head>
    ...
    <script src="${ctx}/static/kd/js/payable/StartSum.js?v=${version}"></script>
</head>
<body>
...
<div class="banner">
    ...
    <div class="banner-right">
        <ul>
            <li>
                <a href="#" class="actives at">发车汇总</a>
            </li>
            <li>
            ...
            <ul class="ul2">
                <li>
                    <a href="#" class="banner-right-a3" id="excelExport"
                       style="color:#3974f8; background: #fff; border: 1px solid #3974f8;">导出EXCEL</a>
                </li>
