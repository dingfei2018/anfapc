...
<div class="banner">
	...
	<div class="banner-right">
		...
		<div class="banner-right-list2">
			<ul class="ul2">
				<li>
					<%--<a href="#" class="banner-right-a3" id="accountId" style="color:#3974f8; background: #fff;border: none;">结算</a>--%>
					<a class="banner-right-a3" onclick="window.location.href='/kd/finance/payable/settlement?transportType=1'">结算</a>
				</li>
				<li>
					<a href="#" class="banner-right-a3" id="excelExport" transportType="1" style="color:#3974f8; background: #fff;text-decoration:underline;border: none;">导出EXCEL</a>
				</li>
				<li>
					<div id="page" style="text-align: center;"></div>
				</li>
			</ul>
			<p class="banner-right-p">提货费列表</p>
