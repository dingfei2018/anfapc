...
<html>
	<head>
		<meta charset="UTF-8">
		<title>库存查询</title>
		<link rel="stylesheet" href="${ctx}/static/kd/css/Inventory2.css" />
		<link rel="stylesheet" href="${ctx}/static/pc/css/head2.css" />
		<link rel="stylesheet" href="${ctx}/static/pc/css/footer.css" />
		<link rel="stylesheet" href="${ctx}/static/pc/css/dropdown.css" />
		<%@ include file="../common/commonhead.jsp" %>
		<script src="${ctx}/static/kd/js/kucun.js?v=${version}"></script>
	</head>
	<body>
		...
		<div class="banner">
			...
			<div class="banner-right">
				<ul>
					<li>
						<a href="#" class="activet at">库存查询</a>
					</li>
					<li>
						<a href="${ctx}/kd/kucun/out" class="at">出库记录</a>
					</li>
				</ul>
				<div class="banner-right-list">
					...
					<div class="div">
					<span class="span">运单号：</span><input type="text" name="shipSn"/><br>
					</div>										
					<div class="div">
