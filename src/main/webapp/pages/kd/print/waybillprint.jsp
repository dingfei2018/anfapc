...
<html>
	...
	<body>
	<%-- <input type="hidden" value="${kdShip.ship_id }" id="shipId"> --%>
	    ...
	    <div style="background: #fff;position: relative;width:95%">
	        ...
	        <p style="margin-top: -14px;" ><b  style="float:left;">托运日期 <span><fmt:formatDate value="${kdShip.create_time }" pattern="yyyy-MM-dd hh:mm:ss"/></span></b> <b style="float:right;">运单号 <span>${kdShip.ship_sn } </span></b></p>
	        <table cellspacing="0" style="width:100%; font-size:14px;  border: 1px solid ;margin-top: 8px;text-align: center;border-left: none;border-right: none;">
	            <tr style=" height:30px;">
	               <td rowspan="5" style="width:70px;border: 1px solid ;">托运方</td>
	               <td style="border: 1px solid ;">出发地</td>
	               <td colspan="3" style="border: 1px solid ;">${kdShip.fromAdd }</td>
	        ...
	        <div> 
	              <ul style="overflow: hidden;margin-top: 5px;margin-left: -35px;width:100%">
	                 <li style="float:left;list-style:none;width:48% ">制单人 : ${kdShip.userName }</li>
	                 <li style="float:left;list-style:none;width:48%  ">托运方签字 : </li>
	              </ul>
	              <ul style="overflow: hidden; margin-left: -35px; margin-top: -10px;width:100%">
	              <li style="float:left;list-style:none;width:48%  ">收货方签字盖章 : </li>	 
	                 <li style="float:left;list-style:none;width:50%  ">收货方身份证号 : </li>
	              </ul>
	              <ul  style="overflow: hidden; margin-left: -35px; margin-top: -10px;width:100%">
	            	  <li  style="float:left;list-style:none;width:48%">公司地址 : ${kdShip.netAddr }</li>
	            	    <li  style="float:left;list-style:none;width:50%">联系电话 : ${kdShip.netTelPhone }</li>
	              </ul>
	        </div>
	        <div style="width: 8mm;height: 127mm;position: absolute;right:-38px;top: 50px; text-align: center;">
	              ① 存根(白)  <br><br>② 托运方(红) <br><br>③ 收货方签收回单(黄)
	         </div>
	      </div> 
	      </div>
	    </div>
	        <button style="margin-left: 500px;width: 120px;height: 40px;margin-top: 50px;font-size: 18px;color: #fff;border: none;background-color: #3974f8;cursor: pointer;" onclick="print();" id="print">打印</button>
