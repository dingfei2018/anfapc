...
<meta charset="UTF-8">
<title>配载减单</title>
<link rel="stylesheet" href="${ctx}/static/kd/css/simple.css" />
<link rel="stylesheet" href="${ctx}/static/pc/css/head2.css" />
<link rel="stylesheet" href="${ctx}/static/pc/css/footer.css" />
<link rel="stylesheet" href="${ctx}/static/pc/css/dropdown.css" />
<%@ include file="../common/commonhead.jsp" %>
<script src="${ctx}/static/kd/js/load/loadreduce.js?v=${version}"></script>
		...
		<div class="banner-right">
            ...
            <div class="banner-right-list3">
             <div class="banner-right-list3-left">
                ...
                <input type="button" class="button" id="comfirmReduce" value="确认减单">
             </div>
                 <div style="width: 100%;overflow-y:auto; overflow-x:auto; height:848px;">
