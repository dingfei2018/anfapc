...
<meta charset="UTF-8">
<title>短驳配送</title>
<link rel="stylesheet" href="${ctx}/static/kd/css/refutation.css" />
<link rel="stylesheet" href="${ctx}/static/pc/css/head2.css" />
<link rel="stylesheet" href="${ctx}/static/pc/css/footer.css" />
<link rel="stylesheet" href="${ctx}/static/pc/css/dropdown.css" />
<%@ include file="../common/commonhead.jsp" %>
<script src="${ctx}/static/kd/js/load/load-refutation.js?v=${version}"></script>
	...
	<div class="banner">
		...
		<div class="banner-right">
			<ul>
				...
				<li><a href="#" class="activet at">短驳配载</a></li>
			...
			<div class="banner-right-list">
				...
				<div class="div">
					<span class="span">短驳费：</span><input type="text" name="load_fee"  id="loadfeeId"/>
				</div>
				<div class="div">
					<span class="span">备注：</span><input name="remark" type="text" />
				</div>
			</div>
