...
<head>
    <meta charset="UTF-8">
    <title>改单记录</title>
    <link rel="stylesheet" href="${ctx}/static/kd/css/switchbill.css" />
    ...
    <div class="banner-right">
       <div class="banner-right-ultitle" style="overflow: hidden;">
           <ul>
               ...
               <li>
                   <a href="/kd/waybill/updateChangeIndex"  class="activet at" >改单记录</a>
               </li>
               <li>
        ...
        <form id="searchForm" onsubmit="return false;" >
            <div class="banner-right-list">
                  ...
                  <div class="div">
                   <span class="span">托运方：</span><input type="text" id="shipperName" name="senderId" />
                  </div>
                  <div class="div">
                      		<span class="span">收货方：</span><input  type="text" id="receivingName" name="receiverId" />
                 	</div>
                  	        <div class="div">
        ...
        <div class="banner-right-list2">
              <ul class="ul2">
                  <li> 
                    <a href="javascript:void(0)"  id="excelExport" class="banner-right-a3" style="color:#3974f8; background: #fff;">导出EXCEL</a>
                  </li>
                  <li>
                      <div id="page" style="text-align: center;">
                  </li>
            </ul> 
            <p class="banner-right-p" style="margin-top:10px;">改单记录列表</p>
            <div style="overflow: auto; width: 100%;  " id="loadingId">
                <table border="0" class="tab_css_1" style="border-collapse:collapse;" id="table">
                    ...
                    <th>修改人</th>
                    <th>修改日期</th>
                    <th style="border-left:1px solid #dcdcdc;width:300px;color:#3974f8;">修改内容</th>
                    </thead>
                </table>
            </div>
            </div>
...
<%@ include file="../common/loginfoot.jsp" %>
    <script src="${ctx}/static/kd/js/waybill/updatechange.js"></script>
</body>
</html>