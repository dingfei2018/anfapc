...
<head>
	<meta charset="UTF-8">
	<title>已到达</title>
	<link rel="stylesheet" href="${ctx}/static/kd/css/confirmation.css" />
...
<div class="banner">
	...
	<div class="banner-right">
		<ul>
			<li>
				<a href="${ctx}/kd/transport" class="at">即将到货</a>
			</li>
			<li>
				<a href="${ctx}/kd/transport/arrive" class="activet at">已到达</a>
			</li>
		</ul>
		...
		<div class="banner-right-list">
			...
			<form  id="searchForm" onsubmit="return false;">
				...
				<div class="div">
					<span class="span">司机：</span><input type="text" name="driverName" id="driverName"  />
				</div>
				<div class="div">
				...
				<div class="div">
					<span class="span">到达日期：</span><input style="margin-left:0px;" type="text" class="Wdate" name="startTime" id="startTime"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd ',isShowClear:false,readOnly:true})"/>
				</div>
				<div class="div">
					<span class="spanc">至</span><input  type="text" class="Wdate" id="endTime" name="endTime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd ',isShowClear:false,readOnly:true})"/>
				</div>
				<div class="div">
					<span class="span">配载单号：</span><input type="text" name="loadSn" id="loadSn"  />
				</div>
		...
		<div class="banner-right-list2">
			...
			<div style="overflow: auto; width: 100%;  " id="loadingId">
				<table border="0" id="loadId" class="tab_css_1" style="border-collapse:collapse;">
					<thead>
					<th>序号</th>
					<th>配载单号</th>
					<th>到货网点</th>
					...
					<th>出发地</th>
					<th>到达地</th>
					<th  class="banner-right-padding">到达时间</th>
					<!-- <th>件数</th> -->
...
<script src="${ctx}/static/kd/js/transport/arrive.js"></script>
</body>
