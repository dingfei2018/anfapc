...
<html>
    ...
    <body>
		...
		<div class="content">
		    ...
		    <br><br><br><br>
                <input type="hidden" id="branchid" name="branchid" value="${branch.id}"></input>
				<label class="label"><span class="content-span">网点地址：</span>
				 	    <span id="startId">
							...
							<script type="text/javascript">
								$("#startId").region({areaField:"area",cityField:"city",domain:"${ctx}",currAreaCode:"${branch.region}"});
							</script><b style="color:red">*</b>
				</label>
				<label class="label2"><span class="content-span">详细地址：</span>
				<input type="text" name="address" id="address" class="content-right-input" value="${branch.address}"><b style="color:red">*</b>
				</label>
				<label class="label3"><span class="content-span">联系人：</span>
				<input type="text" name="contact_man" id="contact_man"  class="content-right-input" value="${branch.sub_leader_name}"><b style="color:white;">*</b>
				</label>
				<label class="label4"><span class="content-span">移动电话：</span>
				<input type="text" name="contact_information" id="contact_information" value="${branch.sub_logistic_mobile}"  class="content-right-input"><b style="color:red">*</b>
			    </label>
			    <label class="label4"><span class="content-span">固定电话 : </span>
				<input type="text" name="sub_logistic_telphone" id="sub_logistic_telphone"  class="content-right-input" value="${branch.sub_logistic_telphone}">
	...
	/* 	function gun(){
			if($(".label3").length == 2){
				...
				$(".content-right-top").append("<label class='label3'><span class='content-span' style='color: #fff;'>联系人 : </span><input type='text' name='contact_man' id='contact_man'  class='content-right-input'><b style='color:white;'>*</b></label>")
			    return;
			}
		} */
	    ...
	    //document.getElementById("contact_information").value = "";
			...
			$.ajax({
					type:"post",
					dataType:"html",
					url:"${ctx}/front/branch/changeBranch", 
					data:{branchid:branchid,region:sarea,address:address,contact_man:contact_man,contact_information:contact_information,sub_logistic_telphone:telphone_str},
