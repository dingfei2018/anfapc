...
<html>
	<head>
		...
		<link rel="stylesheet" href="${ctx}/static/pc/shipped/line.css?v=${version}" />
	...
	<body>
		...
		<div class="content">
		  <p class="p"><a href="${ctx}/index">首页</a> > 按线路发货</p>
		<form action="${ctx}/front/line/searchIndexLine" method="post" id="myform">
		  ...
		  <table cellspacing="0">
		     ...
		     <tr>
		        ...
		        <td><a href="${ctx}/front/line/getLineParkList?parkId=${line.logistics_park_id}&tag=1">${line.parkname}</a></td>
		...
		<script type="text/javascript">
			function search(){
		     ...
		     function sort(column,orderby){
			   ...
			   window.location.href="${ctx}/front/line/searchIndexLine?pageNo="+curr+"&fromCityCode="+fromCityCode+"&fromRegionCode="+fromRegionCode+"&toCityCode="+toCityCode+"&toRegionCode="+toRegionCode+"&column="+column+"&orderby="+orderby;
		    }
		    ...
		    layui.use(['laypage'], function(){
		        ...
		        laypage({
		        	  ...
		        	  ,jump: function(obj, first){
		        	      if(!first){
		        	    	   window.location.href="${ctx}/front/line/searchIndexLine?pageNo="+obj.curr+"&fromCityCode="+fromCityCode+"&fromRegionCode="+fromRegionCode+"&toCityCode="+toCityCode+"&toRegionCode="+toRegionCode+"&column="+column+"&orderby="+orderby;
		        	      }
		        	  }
		        	  ,skin: '#1E9FFF'
		        });
