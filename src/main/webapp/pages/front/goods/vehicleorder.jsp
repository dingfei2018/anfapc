...
<body>
	...
	<%@ include file="../common/loginhead.jsp" %>
		...
		<form id="formid" action="" method="post">
			...
			<input type="hidden" name="model.is_truckload" value="1"> 
			<div class="benner-translate">
				...
				<ul>
					<li>选择类型：</li>
					<li class="" style="margin-left: 7px;"><input type="button" onClick="zero()" value="零担"  class="ld"/></li> 
					<li class="active" ><input type="button" onclick="whole()" value="整车"   class="zc"/></li>
            ...
            <div class="benner-translateo">
            	...
            	<div class="zc_txt">
            	<span>期望运价：</span><input type="text" name="model.truck_freight" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')"/><b>(元),</b><strong>如果运价不填写则默认为面议</strong>
            	</div>
            	<div class="zc_txt"><span class="benner-translateo-span">说明：</span>
            	
            	<textarea id="trunk_remark" name="model.trunk_remark"></textarea></div>
            </div>
