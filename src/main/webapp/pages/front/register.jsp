...
<link rel="stylesheet" href="${ctx }/static/pc/css/register.css?v=${version}" />
...
<body onkeydown="if(event.keyCode==13){checkUser()}">
	...
	<div class="content">
	   ...
	   <div class="content-liso">
			<ul>
			   <li class="actives">物流公司</li>
			   <li><a href="${ctx}/front/register/uwl">非物流公司</a></li>
			</ul>
			...
			<form id="formid" action="" method="post">
				...
				<div class="register-box">
					...
					<input maxlength="20" type="text" name="phoneNumber" id="phoneNumber" lay-verify="required|phone"  placeholder="请输入手机号"   onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')">
							</label >
					<!-- <div class="tips">
							</div> -->
			     	</div>
				...
				<div class="register-box" >
					<label for="username" id="other_label" class="other_label">设置密码
				...
				<div class="register-box">
					<label for="username" id="other_label" class="other_label">确认密码
				...
				<div class="arguement">
					...
					<a href="${ctx}/front/register/regGreement" target="_blank">《网上物流会员服务协议》</a>
					<div class="tips">
					</div>
			    </div>
