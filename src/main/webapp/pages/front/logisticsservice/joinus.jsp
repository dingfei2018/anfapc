...
<html>
	<head>
		...
		<link rel="stylesheet" href="${ctx }/static/pc/css/joinus.css"/>
		...
		<div class="content">
			<div class="content-left">
				<div class="content-left-banner">
					...
					<ul>
						...
						<li class="content-left-main"><a class="content-left-main" href="${ctx }/front/logistics/joinus">加入我们</a></li>	
			...
			<div class="content-right">
				<div class="content-right-main">
					<p class="content-right-page">加入我们</p>
