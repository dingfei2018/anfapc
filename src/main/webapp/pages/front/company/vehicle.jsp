		...
		<form id="formid" action="" method="post">
			...
			<div class="benner-translate">
				...
				<div class="benner-translate-hgn">
					<b>选择类型：</b>
					<ul>
					    <li><a  class="ld_xz" href="${ctx}/company/order?id=${id}&lineId=${line.id}">零担</a></li>
					    <li class="active"><a class="zc_xz" href="${ctx}/company/vehicle?id=${id}&lineId=${line.id}">整车</a></li>
					    <li class="benner-translate-lis"><a href="${ctx}/front/goods/oftenlist" class="benner-translate-hgn-a">+ 我的常发货物</a></li>
					</ul>
				</div>
				
				<div class="benner-translate-map">
                    <p class="benner-translate-bs zsxd_title1">在线信息<span>* 必填</span></p>
					<div id="city_2">
						&nbsp;&nbsp;&nbsp;发货地
						...
						<b>街道/门牌号：<input id="closedfulladdress" name="closedfulladdress"  type="text" onblur="distance()"/></b>
						 <script type="text/javascript">
					       		$("#city_2").region({areaField:"hairarea",cityField:"scity",domain:"${ctx}",currAreaCode:"${line.from_region_code}",callback:function(){distance();}});
					     </script>
					</div>
					...
					<div id="city_3">
						...
						<script type="text/javascript">
					       		$("#city_3").region({areaField:"closedarea",cityField:"ecity",domain:"${ctx}", currAreaCode:"${line.to_region_code}",callback:function(){distance();}});
					     </script>
					</div>
			...
			<div class="benner-translates">
				...
				<table cellspacing="0" class="benner-tables">
					...
					<c:if test="${line !=null}">
						<tr>
							<td>${line.corpname}</td>
							<td class="huang">${line.starting_price}</td>
            ...
            <div class="benner-translatetpl">
                <p class="zsxd_title4">需求说明</p>
            	<span>车辆需求：</span>
            	
            	<select id="truck_length" name="model.truck_length">
            		<option value="1">3.8米</option>
            		<option value="2">4米</option>
            		<option value="3">4.2米</option>
            		<option value="4">4.8米</option>
            		<option value="5">5.2米</option>
            		<option value="6">5.8米</option>
            		<option value="7">6.2米</option>
            		<option value="8">6.8米</option>
            		<option value="9">7.2米</option>
            		<option value="10">7.6米</option>
            		<option value="11">7.8米</option>
            		<option value="12">8米</option>
            		<option value="13">8.6米</option>
            		<option value="14">8.7米</option>
            		<option value="15">8.8米</option>
            		<option value="16">9米</option>
            		<option value="17">9.6米</option>
            		<option value="18">9.8米</option>
            		<option value="19">10米</option>
            		<option value="20">10.6米</option>
            		<option value="21">11米</option>
            		<option value="22.5">12.5米</option>
            		<option value="23">13米</option>
            		<option value="24">13.5米</option>
            		<option value="25">14米</option>
            		<option value="26">14.5米</option>
            		<option value="27">15米</option>
            		<option value="28">15.5米</option>
            		<option value="29">16米</option>
            		<option value="30">16.5米</option>
            		<option value="31">17米</option>
            		<option value="32">17.5米</option>
            		<option value="33">18米</option>
            		<option value="0">其他</option>
            	</select>
            	<select id="truck_type" name="model.truck_type">
            		<option value="1">普通单车</option>
            		<option value="2">普通半挂</option>
            		<option value="3">冷藏车</option>
            		<option value="4">侧帘车</option>
            		<option value="5">双飞翼车</option>
            		<option value="6">改型车</option>
            		<option value="7">罐式车</option>
            		<option value="8">爬梯车</option>
            		<option value="9">特种车辆</option>
            		<option value="10">危险品车</option>
            		<option value="11">笼子车</option>
            		<option value="12">大件车</option>
            		<option value="13">框架车</option>
            	</select>
            	<br />
            	<b><strong>期望运价：<input type="text" name="model.truck_freight"/> (元)，</strong>如果运价不填写则默认为面议</b><br>
            	<span class="benner-translateo-span">说明：</span>
            	<textarea id="trunk_remark" name="model.trunk_remark"></textarea>
            </div>
