...
<html>
	<head>
		...
		<link rel="stylesheet" href="${ctx}/static/pc/logistics/css/tranfas.css?v=${version}" />
		...
		<div class="benner">
		   ...
		   <div class="banner-list">
		      <div class="banner-list-left">
		          <p>公司简介</p>
		          <ul>
		             <li class="banner-list-lefts"><a class="banner-list-lefts-a">关于我们</a></li>
		     ...
		     <div class="banner-list-right">
		         ...
		         <c:if test="${empty shop.shop_desc}">
