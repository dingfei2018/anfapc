...
<html>
	<head>
		...
		<link rel="stylesheet" href="${ctx}/static/pc/logistics/css/Sense.css?v=${version}" />
		...
		<div class="benner">
		   ...
		   <div class="banner-list">
		      <div class="banner-list-left">
		          <p>公司文化</p>
		          <ul>
		             <li><a class="banner-list-lefts-as"  href="${ctx}/company/culture?id=${id}">公司品牌</a></li>
		             <li><a class="banner-list-lefts-as" href="${ctx}/company/mission?id=${id}">公司使命</a></li> 
		             <li class="banner-list-lefts"><a class="banner-list-lefts-a">公司价值观</a></li>
		          </ul>
