...
(function (factory) {
    ...
    CityPicker.prototype = {
        ...
        render: function () {
        	var t = this.$element.attr("data-type");
            var p = this.getPosition(),
                placeholder = this.$element.attr('placeholder') || this.options.placeholder,
                textspan = '<span class="city-picker-span" style="' +
                    this.getWidthStyle(300) + 'height:' +
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;' +
                    ...
                    (this.includeDem('district')&&!t? '<a data-count="district">区县</a>' : '') + '</div>' +
                    '<div class="city-select-content">' +
                    '<div class="city-select province" data-count="province"></div>' +
                    (this.includeDem('city') ? '<div class="city-select city" data-count="city"></div>' : '') +
                    (this.includeDem('district')&&!t? '<div class="city-select district" data-count="district"></div>' : '') +
                    '</div></div>';
        ...
        bind: function () {
            ...
            this.$dropdown.on('click', '.city-select a', function () {
                ...
                var clast = $select.next().length === 1;
                ...
                if ($active.data('code') !== $(this).data('code')) {
                    ...
                    $this.feedText();
                    $this.feedVal();
                    var t = $($this.$dropdown).siblings("input[data-toggle='city-picker']").attr("data-type");
                    if(clast&&t){
                    	$($this.$dropdown).find("div[data-count='city']").find("a").first().click();
                    	$($this.$textspan).find("span[data-count='city']").click();
                    }
        ...
        getText: function () {
            ...
            if(this.$element.prev("input"))this.$element.prev("input").val(code);
            return text;
        },
