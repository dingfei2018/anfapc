...
(function($){
    ...
    Hkhk.prototype={
        init:function(){
            ...
            $("#huikuan").bind("click", $.proxy(function () {
                this.huikuan();
            }, this));
        ...
        getData:function(param, pageNo, obj){
            ...
            $.ajax({
                type:'GET',
                url:'/kd/finance/collect/getmoneyRemittanceList',
        ...
        huikuan:function(){
            ...
            var mess = "<p>确认"+feeTotal+"元货款已汇款</p>";
            layer.confirm(mess, {
                    title: '确认货款已汇款',
                    btn: ['确定','取消']
                }, function(){
            $.ajax({
                type:'POST',
                url:'/kd/finance/collect/saveShipFlow?type=3&ids='+$this.selectIds.join(),
