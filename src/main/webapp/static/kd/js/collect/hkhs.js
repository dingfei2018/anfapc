...
(function($){
    ...
    Hkhs.prototype={
        init:function(){
            ...
            $("#huishou").bind("click", $.proxy(function () {
                this.huishou();
            }, this));
        ...
        getData:function(param, pageNo, obj){
            ...
            $.ajax({
                type:'GET',
                url:'/kd/finance/collect/getmoneyCallBackList',
        ...
        huishou:function(){
            ...
            var mess = "<p>确认"+feeTotal+"元货款已回收</p>";
            layer.confirm(mess, {
                    title: '确认货款已回收',
                    btn: ['确定','取消']
                }, function(){
            $.ajax({
                type:'POST',
                url:'/kd/finance/collect/saveShipFlow?type=2&ids='+$this.selectIds.join(),
