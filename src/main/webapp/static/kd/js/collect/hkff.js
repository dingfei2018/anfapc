...
(function($){
    ...
    Hkff.prototype={
        init:function(){
            ...
            $("#fafang").bind("click", $.proxy(function () {
                this.fafang();
            }, this));
        ...
        getData:function(param, pageNo, obj){
            ...
            $.ajax({
                type:'GET',
                url:'/kd/finance/collect/getmoneyGrantList',
        ...
        fafang:function(e){
            ...
            var mess = "<p>确认"+feeTotal+"元货款已发放</p>";
            layer.confirm(mess, {
                    title: '确认货款已发放',
                    btn: ['确定','取消']
                }, function(){
            $.ajax({
                type:'POST',
                url:'/kd/finance/collect/saveShipFlow?type=5&ids='+$this.selectIds.join(),
