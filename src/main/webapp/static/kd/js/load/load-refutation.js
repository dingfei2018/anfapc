...
ShipLoading.prototype={
		...
		search:function(){
			var param ="type=2&endCode="+$("#endCode").val()+"&networkId="+$("#networkId").val()+"&pageNo=1";
		...
		fahuo:function(){
			...
			sdata +="&load_transport_type=2&load_next_network_id=0&ids="+this.selectIds.join();
			$.ajax({
				type:'POST',
				url:'/kd/loading/up',
				data:sdata,
