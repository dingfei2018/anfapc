...
(function($){
    ...
    Ship.prototype={
        ...
        appendHtml:function(obj, index){
            ...
            html += "<td>"+obj.abnormalNetWorkName+"</td>";

            html += "<td>"+((obj.goods_sn==null)?"":obj.goods_sn)+"</td>";
            ...
            html += "<td>"+(((obj.fee_status==null)||(obj.fee_status==0))?"未结算":"已结算")+"</td>";
            ...
            html += "<td><a class=\"banner-right-a1\" href=\"#\" onclick=\"goUpdate("+obj.ship_id+","+obj.fee_status+")\">修改</a>" +
                "<a class=\"banner-right-a2\" href=\"javascript:void(0)\" onclick=\"deleteLine("+obj.ship_id+","+obj.fee_status+")\">删除</a></td></tr>";
            return html;
        ...
        excelExport:function(){
            ...
            layer.confirm('您确定要导出excel？', {
                ...
                window.location.href="/kd/finance/abnormal/exportShipAbnormalExcel?"+obj.searchParam;
                layer.close(index);
            }, function(){});
        }
    };
