//应收管理（提付）
(function($){
function RePickupPay(){
	this.searchParam = "";
	this.init();
}
    RePickupPay.prototype={
		init:function(){
		...
		appendHtml:function(obj,index){
        	...
        	html+='<tr>' +
                	...
                	'<td style="color:orange;">'+obj.ship_pickuppay_fee+'</td>'+
		...
		excelExport:function(){
			...
			layer.confirm('您确定要导出excel？', {
    			...
    			window.location.href="/kd/finance/receivable/downExcel?flag=2&"+obj.searchParam;
    			layer.close(index);
    		}, function(){});
		}
};
