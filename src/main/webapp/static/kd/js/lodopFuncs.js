...
function getLodop(oOBJECT,oEMBED){
    ...
    //var strCLodopInstall="<br><font color='#FF00FF'>CLodop云打印服务(localhost本地)未安装启动!点击这里<a href='/static/kd/lodop/CLodop_Setup_for_Win32NT.exe' target='_self'>执行安装</a>,安装后请刷新页面。</font>";
    var strCLodopInstall= confirm("CLodop云打印服务(localhost本地)未安装启动!点击这里安装后请刷新页面。");
    if(strCLodopInstall){
    	 /*<a href='/static/kd/lodop/CLodop_Setup_for_Win32NT.exe' target='_self'>执行安装</a>*/
    	window.location.href = "/static/kd/lodop/CLodop_Setup_for_Win32NT.exe"
    	}
