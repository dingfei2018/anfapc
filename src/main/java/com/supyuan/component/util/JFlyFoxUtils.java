...
public class JFlyFoxUtils {
	...
	public static boolean isBack(String path) {
		// 后台需要认证页面
		String[] backs = { "system/", "admin/", "front/userconter", "front/goods", "front/goods/vehiclelist",
				"front/order", "company/makeOrder", "company/vehicle", "company/order",
				"cpy/admin", "front/goods/oftenlist","front/branch", "front/message/showUnRead", "kd" 
				};
		if (path.startsWith("login") //
				|| path.startsWith("logout") || path.startsWith("front/user/logout") || (path.startsWith("front/user")&&!path.startsWith("front/userconter"))) {
			return false;
		}
