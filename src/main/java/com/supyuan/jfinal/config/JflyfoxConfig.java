...
import com.supyuan.jfinal.component.handler.JflyfoxHandler;
...
public class JflyfoxConfig extends JFinalConfig {
	...
	public void configConstant(Constants me) {
		...
		me.setBaseUploadPath(Config.getStr("FILE.UPLOAD_PATH"));
	}
	...
	public void afterJFinalStart() {
		...
		JFinal.me().getServletContext().setAttribute("CUSTOMER.SERVICE", Config.getStr("CUSTOMER.SERVICE"));
		// 初始化Cache为fst序列化
