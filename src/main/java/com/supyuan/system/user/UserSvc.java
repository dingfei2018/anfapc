...
//		String menuids = "select menu_id from sys_role_menu where role_id in"
//				+ " ( select role_id from sys_user_role where userid = ? ) group by menu_id";
//		// 管理员
...
//				userRole.set("role_id", NumberUtils.parseInt(role_id));
//
//				// 日志添加
